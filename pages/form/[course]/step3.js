...
export default function Step3() {
  ...
  const handleSubmit = e => {
    ...
    // → replace with real FormData POST…
  }
          ...
          {passFail === 'Pass' ? (
            <>
              ...
              <p>
                cbt-candidate-path –{' '}
                <a
                  href="https://www.cfainstitute.org/-/media/documents/factsheet/cbt-candidate-pathing-infographic.pdf"
                  target="_blank"
              ...
              <p>
                ...
                <a
                  href="https://www.youtube.com/channel/UCyt8himITSzSOU9ktWlxc8g/playlists"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  YouTube playlists
            ...
            <>
              ...
              <p>
                <a
                  href="https://www.dropbox.com/s/msdiw44ls2612p9/Did%20Not%20Clear.mp3?dl=0"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <p>
                ...
                <a
                  href="https://study.aswinibajaj.com/inspect/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  introspection form
              ...
              <p>
                We will also shift you to the new WhatsApp group in 5-7 working days. Meanwhile, start here:{' '}
                <a
                  href="https://www.youtube.com/channel/UCyt8himITSzSOU9ktWlxc8g/playlists"
                  target="_blank"
                  rel="noopener noreferrer"
